...
export type TImenu_item = typeof menuItemTable.$inferInsert;
export type TSmenu_item = typeof menuItemTable.$inferInsert;
...
export type TIrestaurant_owner = typeof restaurant_ownerTable.$inferInsert;
export type TSrestaurant_owner = typeof restaurant_ownerTable.$inferInsert;
export type TIaddress = typeof addressTable.$inferInsert;
export type TSaddress = typeof addressTable.$inferInsert;
export type TIorder_menu_item = typeof order_menu_itemTable.$inferInsert;
export type TSorder_menu_item = typeof order_menu_itemTable.$inferInsert;
export type TIorder = typeof orderTable.$inferInsert;
export type TSorder = typeof orderTable.$inferInsert;
export type TIdriver = typeof driverTable.$inferInsert;
export type TSdriver = typeof driverTable.$inferInsert;
export type TIorder_status = typeof order_statusTable.$inferInsert;
export type TSorder_status = typeof order_statusTable.$inferInsert;
export type TIstats_catalogue = typeof stats_catalogueTable.$inferInsert;
export type TSstats_catalogue = typeof stats_catalogueTable.$inferInsert;
export type TIcomment = typeof commentTable.$inferInsert;
export type TScomment = typeof commentTable.$inferInsert;
export type TIAuthOnUsers = typeof AuthOnUserTable.$inferInsert;
export type TSAuthOnUsers = typeof AuthOnUserTable.$inferInsert;
//one-many relations
   ...
   // order menu item relations
    ...
    export const state_city_relations = relations(stateTable, ({many})=>({
        cities:many(cityTable)
    }))

    // city and state relations
    export const city_state_relations = relations(cityTable, ({one})=>({
...
export const AuthOnUserTableRelations = relations(AuthOnUserTable, ({ one }) => ({
    user: one(userTable, {
